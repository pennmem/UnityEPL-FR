...
public class RepFRExperiment2 : ExperimentBase2
{
    ...
    public RepFRExperiment2(InterfaceManager2 _manager) : base(_manager)
    {
    ...
    public override States GetStateMachine2() {
        States IntroStates = new States() {
            IntroductionVideo,
        };

        States MainStates = new States() {
            IntroStates,
        };
